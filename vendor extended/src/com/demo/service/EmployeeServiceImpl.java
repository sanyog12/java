...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public void addnewEmployee(int ch) {
		...
		if(ch==1) {
			...
			e = new VendorEmp(pid, nm, mob, em, dept, desg, ldt, workers, amount);
		}
		edao.save(e);
	}
	...
	@Override
	public boolean modifyCharById(int id, double charges) {
		return edao.updateCharById(id,charges);
	}
	
	@Override
	public boolean modifyAmtById(int id, double amount) {
		return edao.updateAmtById(id, amount);
	}
